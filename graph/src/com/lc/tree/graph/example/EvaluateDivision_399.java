...
import com.lc.tree.graph.template.itemplate.Edge;
import com.lc.tree.graph.template.itemplate.IGraphGenerator;
import com.lc.tree.graph.template.itemplate.Graph;
import com.lc.tree.graph.template.itemplate.Node;
    ...
    Graph<String> createGraph(List<List<String>> equations, double[] values) {
        ...
        for(int i=0;i<equations.size();i++) {
            ...
            if(!graph.nodes.containsKey(from)) {
                graph.nodes.put(from, new com.lc.tree.graph.template.itemplate.Node<>(from));
            }

            if(!graph.nodes.containsKey(to)) {
                graph.nodes.put(to, new com.lc.tree.graph.template.itemplate.Node<>(to));
            }

            com.lc.tree.graph.template.itemplate.Node<String> fromNode = graph.nodes.get(from);
...
public class EvaluateDivision_399 {
    ...
    public static double[] calcEquation(List<List<String>> equations, double[] values, List<List<String>> queries) {
        ...
        HashSet<com.lc.tree.graph.template.itemplate.Node<String>> visited = new HashSet<>();
    ...
    private static void dfs(com.lc.tree.graph.template.itemplate.Node<String> from, com.lc.tree.graph.template.itemplate.Node<String> to, int index,
                            double[] res, double val, HashSet<com.lc.tree.graph.template.itemplate.Node<String>> visited) {
